...
#root.iconbitmap(default='restro_png.ico')
...
title_label = tk.Label(header_frame, text="RESTRO", font=("Arial", 30, "bold"), bg="deep sky blue", fg="white")
...
welcome_label = tk.Label(bill_frame, text="||---- JAY SHREE RAM ----||\n Welcome to KAKA RESTAURANT ...", font=custom_font, bg="white")
welcome_label.pack()
...
customer_details_frame = tk.Frame(bill_frame, bg="white")
customer_details_frame.pack(fill="x")

# Create labels for customer name and mobile number
customer_name_label = tk.Label(customer_details_frame, text="Customer Name:", font=custom_font, bg="white")
...
mob_no_label = tk.Label(customer_details_frame, text="Mob No:", font=custom_font, bg="white")
...
def store_billing_data():
    ...
    insert_query = "INSERT INTO bills (customer_name, phone_no, ordered_items, total_amount, order_datetime) VALUES (%s, %s, %s, %s, %s)"
    data = (customer_name, phone_no, ordered_items, total_amount, order_datetime)
...
thank_you_label = tk.Label(bill_frame, text="Thank you, visit again!!", font=custom_font, bg="white")
